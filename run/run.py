...
class Runner:
	...
	def send_mail(self, to_user, sub, content):
		...
		global send_mail
		global send_user
		send_mail = 'smtp.tianyigps.cn'
		send_user = 'lishuaibin@tianyigps.cn'
		...
		server.login('lishuaibin@tianyigps.cn', 'Li13572597243')
